...
const allCardsWithTagsHTMLOrJSThatAreBookmarked = cards.filter((card)=>{return
  (card.tags.includes("html")&&card.isBookmarked)||(card.tags.includes("js") && card.isBookmarked)});
