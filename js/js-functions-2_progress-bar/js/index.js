...
function calculateScrollPercentage() {
  ...
  const maxScrollValue = document.body.clientHeight;

  const percentage = (scrollPosiiton * 100) / maxScrollValue;

  progresBar.style.width = percentage * "%";

  /*
  console.log(percetage);
  console.log(windows.scrollY, windows.innerHeight, document.body);
  */
}
